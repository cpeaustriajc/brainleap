...
ALTER TABLE ONLY "public"."announcements"
    ADD CONSTRAINT "announcements_course_id_fkey" FOREIGN KEY (course_id) REFERENCES public.courses(course_id) ON UPDATE CASCADE ON DELETE CASCADE;

ALTER TABLE ONLY "public"."assignments"
    ADD CONSTRAINT "assignments_instructor_id_fkey" FOREIGN KEY (instructor_id) REFERENCES public.profiles(profile_id) ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."outputs"
    ADD CONSTRAINT "outputs_assignment_id_fkey" FOREIGN KEY (assignment_id) REFERENCES public.assignments(assignment_id) ON DELETE CASCADE;

ALTER TABLE ONLY "public"."outputs"
    ADD CONSTRAINT "outputs_course_id_fkey" FOREIGN KEY (course_id) REFERENCES public.courses(course_id) ON UPDATE CASCADE ON DELETE CASCADE;
