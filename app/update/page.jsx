        ...
        <>
            <section className="form-container">
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <p>update name</p>
                    <input type="text" name="name" placeholder="ewan" maxlength="50" className="box" />
                    <p>update email</p>
                    <input type="email" name="email" placeholder="missnakita@gmail.com" maxlength="50" className="box" />
