        ...
        <>
            <section className="watch-video">
                ...
                <div className="video-container">
                    ...
                    <div className="info">
                        <p className="date"><i className="fas fa-calendar"></i><span>10-10-2023</span></p>
            ...
            <section className="comments">
                ...
                <div className="box-container">
                    ...
                    <div className="box">
                        ...
                        <div className="comment-box">wow amazin nakakaPUTANGINAAAAAAA</div>
                        <form action="" className="flex-btn">
                            ...
                            <div className="box">
                                ...
                                <div className="comment-box">Ikaw lang ang aking mahal ralph
                                </div>
                            </div>
                            ...
                            <div className="box">
                                ...
                                <div className="comment-box">I think mas-maganda kung ako na lang magtuturo kay erica ng lesson na to.</div>
                            </div>
                            ...
                            <div className="box">
                                ...
                                <div className="comment-box">ikaw lamng ang akin iniirog</div>
                            </div>
                            ...
                            <div className="box">
                                ...
                                <div className="comment-box"> lf bebetime!
                                </div>
                            </div>
