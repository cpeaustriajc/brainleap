            ...
            <section className="contact">
                ...
                <div className="box-container">
                    ...
                    <div className="box">
                        ...
                        <h3>email address</h3>
                        <a href="mailto:minahalkita@gmail.com">minahalkita@gmail.com</a>
                        <a href="mailto:missnakita@gmail.com">missnakita@gmail.come</a>
                    </div>

                    <div className="box">
                        <i className="fas fa-map-marker-alt"></i>
                        <h3>office address</h3>
                        <a href="#">Miss na kita balik ka na ito address ko block 69 lot 69 miss ka na st. </a>
                    </div>
                </div>
            </section>
